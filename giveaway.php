 ...
 <input type="submit" id="logout" value="Logout" name="logout">
    ...
    <nav>
        <ul style="display:flex; background-color:black; justify-content: space-between;">
            ...
            <li class="list-items" id="home-tag"><a href="login.php" class="active" id="home-text">Have a pet to
                    give away</a></li>
...
<form id="formGive" action="gaveThePet.php">
<script src="Q8.js"> </script>
<fieldset>
   <legend>
   ...
   <script src="Q8.js"></script>
   <input onclick="validateFormGiveaway()" type="submit" value="Submit" > <input type="reset" value="Reset">
</fieldset>
</form>
