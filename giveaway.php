...
<body>
 ...
 <input type="submit" id="logout" value="Logout" name="logout">
    ...
    <!-- <form onsubmit="return validateFormGiveaway()">
        <fieldset>
            <legend>
                <h2>Please fill in the following information to give a pet!</h2>
            </legend>
            <label>Is your pet a dog or a cat?</label> <label><input type="radio" name="Dog/Cat" value="Dog">Dog</label>
            <label><input type="radio" name="Dog/Cat" value="cat">Cat</label>
            <label>
                <br>
            ...
            <br><br>
            <label>Anything noteworthy about your pet that you want to brag about?<br><textarea rows="10" cols="50" name="required">
                </textarea></label>
            <br><br>
            <label>Family Name?<input type="text" name="required"></label><br><label>Given name? <input type="text" name="required"></label>
            <br><br>
            ...
            while (($line = fgets($file1)) !== false) {
                ...
                if ($userInFile==$username1&&$passInFile==$password1){
                    ...
                    echo '   <h2> Login Succesful! </h2>
                     <form onsubmit="return validateFormGiveaway()" action="gaveThePet.php">
                    <fieldset>
                        <legend>
                            <h2>Please fill in the following information to give a pet!</h2>
                        </legend>
                        ...
                        <br><br>
                        <label>Family Name?<input type="text" name="requiredName" required></label><br><label>Given name? <input type="text" name="requiredGiven" required></label>
                        <br><br>
                        <label>Email<input type="text" name="requiredEmail" required></label>
                        <br>
                        <p>Thank you for participating in the survey! </p>
                        <input type="submit" value="Submit"> <input type="reset" value="Reset">
                    </fieldset>
